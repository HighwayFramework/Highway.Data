...
{
    /// <summary>
    /// This query is tied to the implementation of NHibernate
    /// </summary>
    ...
    public class AdvancedQuery<TSelection, TProjection> : QueryBase, IQuery<TSelection, TProjection> where TSelection : class
    {
