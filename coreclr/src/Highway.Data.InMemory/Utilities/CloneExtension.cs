...
namespace Highway.Data.InMemory.Utilities
{
    public static class CloneExtension
    {
        ...
        private static void CloneFieldsForType<T>(T originalObject, T cloneObject, Type type)
        {
            ...
            foreach (var field in fields)
            {
                ...
                if (fieldInfo.FieldType.GetTypeInfo().IsPrimitive || fieldInfo.FieldType == typeof(string) || fieldInfo.FieldType == typeof(Guid)) fieldInfo.SetValue(cloneObject, value);
                else
                {
