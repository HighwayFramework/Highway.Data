...
namespace Highway.Data.Security.DataEntitlements.Expressions
{
    ...
    {
        /// <summary>
        /// Represents a relationship between between two types, one of which is  by the other.
        /// </summary>
        /// <param name="secured">The  Type.</param>
        /// <param name="securedBy">The Type by which <paramref name="secured"/> is .</param>
        ...
        /// <summary>
        /// The Type by which <see cref="SecuredRelationship.Secured"/> is .
        /// </summary>
