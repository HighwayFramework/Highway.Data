...
namespace Highway.Data.EntityFramework.Security.Expressions
{
    public class ParameterToMemberExpressionRebinder : ExpressionVisitor
    {
        ...
        ///     The expression representing the original usage.
        /// </param>
        /// <param name="memberExpression">
        ///     The epxression representing the usage to rebind to.
        /// </param>
        public ParameterToMemberExpressionRebinder(ParameterExpression parameterExpression,
        ...
        /// </summary>
        /// <typeparam name="T">
        ///     The Type of the new root expression.
        /// </typeparam>
        /// <typeparam name="T2">
        ///     The Type of the old root expression.
        /// </typeparam>
        /// <param name="propertySelector">
        ///     The expression to replace the original parameter with.
        /// </param>
        /// <param name="propertyPredicate">
        ///     The predicate built on the original parameter.
        /// </param>
        /// <returns>
        ///     A predicate on the rebound root expression.
        /// </returns>
        ...
        {
            var result = CombineSinglePropertySelectorWithPredicate((LambdaExpression) propertySelector,
                propertyPredicate);
        ...
        /// </param>
        /// <returns>
        ///     The new member expression if <paramref name="p" /> is the current expression.  Otherwise returns
        ///     <paramref name="p" />.
        /// </returns>
