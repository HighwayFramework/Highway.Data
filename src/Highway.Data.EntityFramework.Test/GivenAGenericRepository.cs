// <copyright file="GivenAGenericRepository.cs" company="Enterprise Products Partners L.P. (Enterprise)">
    ...
    public class GivenAGenericRepository
    {
        ...
        public void Setup()
        {
            _context = new TestDataContext(
                "Data Source=(localDb);Initial Catalog=Highway.Data.Test.Db;Integrated Security=True",
