...
namespace Highway.Data.EntityFramework.DynamicFilters
{
    public static class DynamicFilterExtensions
    {
        ...
        /// </summary>
        private static readonly ConcurrentDictionary<string, DynamicFilterParameters> _GlobalParameterValues =
...
#pragma warning disable 618
        [Obsolete("Use modelBuilder.Filter() instead")]
        public static EntityTypeConfiguration<TEntity> Filter<TEntity, TProperty>(
        ...
        public static void Filter<TEntity, TProperty>(this DbModelBuilder modelBuilder, string filterName,
            Expression<Func<TEntity, TProperty>> path, Func<object> globalFuncValue)
            where TEntity : class
        {
        ...
        public static void Filter<TEntity, T0>(this DbModelBuilder modelBuilder, string filterName,
            Expression<Func<TEntity, T0, bool>> predicate, Func<T0> value0)
            where TEntity : class
        {
        ...
        public static void Filter<TEntity, T0>(this DbModelBuilder modelBuilder, string filterName,
            Expression<Func<TEntity, T0, bool>> predicate, T0 value0)
            where TEntity : class
        {
            Filter<TEntity>(modelBuilder, filterName, predicate, (object) value0);
        }
        ...
        public static void Filter<TEntity, T0, T1>(this DbModelBuilder modelBuilder, string filterName,
            Expression<Func<TEntity, T0, T1, bool>> predicate,
        ...
        public static void Filter<TEntity, T0, T1, T2>(this DbModelBuilder modelBuilder, string filterName,
            Expression<Func<TEntity, T0, T1, T2, bool>> predicate,
        ...
        public static void Filter<TEntity, T0, T1, T2, T3>(this DbModelBuilder modelBuilder, string filterName,
            Expression<Func<TEntity, T0, T1, T2, T3, bool>> predicate,
        ...
        public static void Filter<TEntity, T0, T1, T2, T3, T4>(this DbModelBuilder modelBuilder, string filterName,
            Expression<Func<TEntity, T0, T1, T2, T3, T4, bool>> predicate,
            ...
            params object[] valueList)
        {
            ...
            var numParams = predicate.Parameters == null ? 0 : predicate.Parameters.Count;
            ...
            object value)
        {
            ...
            var globalFilterParams = _GlobalParameterValues[filterName]; //  Already validated that this exists.
        ...
        public static void ClearScopedParameters(this DbContext context)
        {
            ...
            Debug.Print("Cleared scoped parameters.  Have {0} scopes", _ScopedParameterValues.Count);
        }
        ...
        private static DynamicFilterParameters GetOrCreateScopedFilterParameters(DbContext context, string filterName)
        {
            ...
            {
                Debug.Print("Created new scoped filter params.  Have {0} scopes", _ScopedParameterValues.Count);
