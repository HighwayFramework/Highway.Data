...
namespace Highway.Data.Rest.Expressions
{
    ...
    {
        public static Expression<Func<object, object>> ConvertParameterToObject<T, TK>(
            this Expression<Func<T, TK>> source)
        {
            return source.ReplaceParameterWithBase<T, TK, object>();
        }

        public static Expression<Func<TBase, TBase>> ReplaceParameterWithBase<T, TResult, TBase>(
